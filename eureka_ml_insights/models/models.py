...
@dataclass
class DirectOpenAIOModel(OpenAIO1RequestResponseMixIn, DirectOpenAIClientMixIn, EndpointModel):
    model_name: str = None
    temperature: float = 1
...
@dataclass
class AzureOpenAIOModel(OpenAIO1RequestResponseMixIn, AzureOpenAIClientMixIn, EndpointModel):
    url: str = None
    model_name: str = None
    temperature: float = 1
    # Not used currently, because the API throws:
